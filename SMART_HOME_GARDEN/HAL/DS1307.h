 ...
 * Notes:
 ***********************************************************************/
extern void void_DS1307_Init(void);
 ...
 * Return Value: Void
 ***********************************************************************/
extern void void_DS1307_SetTime(U8_t hh, U8_t mm, U8_t ss);
 ...
 * Notes:
 ***********************************************************************/
extern void void_DS1307_SetDate(U8_t dd, U8_t mm, U8_t yy);
 ...
 * Notes:
 *********************************************************************************/
extern void void_DS1307_GetTime(U8_t *h_ptr,U8_t *m_ptr,U8_t *s_ptr);
 ...
 * Notes:
 ***********************************************************************/
extern void void_DS1307_GetDate(U8_t *d_ptr,U8_t *m_ptr,U8_t *y_ptr);
